...
import type { GraphPersistedState, GraphState, GraphAction } from '../../_types/graph';
...
type GraphProviderProps = {
    children: ReactNode;
    initialState?: GraphPersistedState;
};

const GraphProvider = ({ children, initialState: persistedState }: GraphProviderProps) => {
